  ...
  return (
    <Container>
      <Detail>
        ...
        <h2>
          Bank Name:{" "}
          {bankDetails?.bank_name ? bankDetails?.bank_name : bank?.bank_name}
        </h2>
        <p>
          Account Name:{" "}
        ...
        <p>
          Account created{" "}
          {getDate(
            bankDetails?.created_at ? bankDetails?.created_at : bank?.created_at
          )}
        </p>
        <p>
          Account updated{" "}
          {getDate(
            bankDetails?.updated_at ? bankDetails?.updated_at : bank?.updated_at
          )}
        </p>
      </Detail>
    </Container>
